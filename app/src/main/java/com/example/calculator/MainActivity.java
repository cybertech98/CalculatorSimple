...
public class MainActivity extends AppCompatActivity {
    ...
    Button number_1, number_2,number_3, number_4,number_5,number_6,number_7,number_8,number_9, clear, right_braces, left_braces,
    multiply, divide, plus, minus, point, equal;
